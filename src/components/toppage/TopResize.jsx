...
const TopResize = () => {
    return (
        <div className="flex flex-col items-center justify-center  pt-5">
            <div className="py-2 pl-[5vw] lg:pl-0  ">
                <h2 className={`${ResolveThin.className} text-[4em] md:text-[5em] leading-none h-[200px] pt-10 text-white`}>CHRISTIAN JOHNS</h2>
            </div>
            <div className="flex flex-col items-center" >
                <div>
                    <Image className="w-[50%] sm2:w-full" src="https://iili.io/dr0IS0x.jpg" width={1000} height={1000} alt="fotin" />
                </div>
